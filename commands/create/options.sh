...
# Created: Fri Dec 18 10:08:38 PST 2015
#
#/ usage: rundeck-acls:create  --aclpolicy <> [ --file <>] [ --project <>] [ --group <>]  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>] 
