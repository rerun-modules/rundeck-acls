...
# Created: Wed Dec 16 10:06:28 PST 2015
#
#/ usage: rundeck-acls:create  --aclpolicy <> [ --file <>] [ --project <>]  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>] [ --group <>] 
