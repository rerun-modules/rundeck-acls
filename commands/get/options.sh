...
# Created: Tue Dec 15 14:21:33 PST 2015
#
#/ usage: rundeck-acls:get  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>]  --aclpolicy <> 
